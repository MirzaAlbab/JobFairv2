                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="align-middle">                       
                      <a href="{{ route('company-job-view',$job->id) }}" class="btn btn-primary btn-sm" role="button" aria-pressed="true" title="View"><i class="bi bi-eye"></i></a>
                      <a href="{{ route('company-job-edit',$job->id) }}" class="btn btn-warning btn-sm" role="button" aria-pressed="true" title="Edit"><i class="bi bi-pencil-square"></i></a>
                      <!-- Delete Modal -->
