        ...
        <div class="card-body">
          ...
          <form action="{{ route('gallery-update', $gallery->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" value="{{ old('judul', $gallery->title) }}">
                @error('judul')
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                @if ($gallery->img)
                  <img src="{{ asset('laravel/storage/app/'. $gallery->img) }}" class="img-preview img-fluid mb-3 col-sm-5">
                @else
