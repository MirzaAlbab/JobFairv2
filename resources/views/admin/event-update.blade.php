        ...
        <div class="card-body">
          ...
          <form action="{{ route('event-update', $event->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" value="{{ old('judul', $event->title) }}" required>
                @error('judul')
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <div>
                  <textarea class="form-control" id="editor" name="deskripsi" required>{!! old('deskripsi', $event->description) !!}</textarea>
                  @error('deskripsi')
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="datetime-local" class="form-control @error('waktu') is-invalid @enderror" name="waktu" value="{{ date('Y-m-d\TH:i', strtotime($event->time)) }}" required>
                @error('waktu')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                @if ($event->img)
                  <img src="{{ asset('storage/'. $event->img) }}" class="img-preview img-fluid mb-3 col-sm-5">
                @else
